...
var config;
if (fs.existsSync(path.resolve(__dirname, './../rt/config.r.json')))
    config = require('./../rt/config.r.json');
...
exports.showQrCode = function (uuid) {
    return new Promise(function (resolve, reject) {
        ...
        qrcode.generate('https://login.weixin.qq.com/l/' + uuid, { small: false }, function (qrcode) {
            console.log(qrcode);
            resolve({ url: 'https://login.weixin.qq.com/qrcode/' + uuid, msg: '二维码显示成功，请扫描...' });
        });
        // } else {
...
exports.wxInit = function () {
    return new Promise(function (resolve, reject) {
        ...
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.wxStatusNotify = function () {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.wxSendTextMsg = function (content, from, to) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.getContact = function (seq) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
        config.options.path = config.wxPath.getContact + '?seq' + seq + '&r=' + new Date().getTime() + '&skey=' + config.wxConfig.skey + '&pass_ticket=' + config.wxConfig.pass_ticket;;
        config.options.method = 'POST';
        config.data = {
            BaseRequest: {
                Uin: config.wxConfig.wxuin,
 ...
 * @author   ryan
 */
exports.getGroupList = function (groupIds) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.syncCheck = function () {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host.replace('//', '//webpush.');
        var key = "";
        ...
        config.options.path = config.wxPath.syncCheck + '?r=' + new Date().getTime() + '&uin=' + config.wxConfig.wxuin + '&sid=' + config.wxConfig.wxsid + '&skey=' + config.wxConfig.skey + '&deviceid=' + deviceID + '&_=' + new Date().getTime() + '&synckey=' + key;
 ...
 * @author   ryan
 */
exports.createChatRoom = function (topic, memberList) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.updateChatRoom = function (chatRoomUserName, memberList, fun) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.getHeadImg = function (username) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.revokeMsg = function (msgId, toId) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
 ...
 * @author   ryan
 */
exports.pushLogin = function (uin) {
    return new Promise(function (resolve, reject) {
        config.options.hostname = config.wxConfig.host;
        if (uin) {
